...
// Fixed-Time Motion
  ...
  #endif
  #if ANY(FTM_POLYS, FTM_CONSTANT_JERK)
    #define HAS_FTM_TRAJECTORY_SELECTION 1
  #endif
  // Ensure FTM_TRAJECTORY_TYPE has a default when only FTM_CONSTANT_JERK is enabled
  #if ENABLED(FTM_CONSTANT_JERK) && DISABLED(FTM_POLYS) && !defined(FTM_TRAJECTORY_TYPE)
    #define FTM_TRAJECTORY_TYPE CONSTANT_JERK
  #endif
#endif
