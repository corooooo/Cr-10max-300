 ...
 */
  ...
  #elif ENABLED(BABYSTEP_GFX_OVERLAY) && NONE(BABYSTEP_ZPROBE_OFFSET, BABYSTEP_GLOBAL_Z)
    #error "BABYSTEP_GFX_OVERLAY requires BABYSTEP_ZPROBE_OFFSET or BABYSTEP_GLOBAL_Z."
